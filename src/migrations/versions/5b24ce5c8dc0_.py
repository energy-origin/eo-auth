...
Revision ID: 5b24ce5c8dc0
Revises: 
Create Date: 2021-10-13 10:31:01.264098
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('cpr', sa.String(), nullable=False),
    sa.Column('created', sa.DateTime(timezone=True), nullable=False),
    sa.Column('internal_subject', sa.String(), nullable=False),
    sa.Column('external_subject', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_cpr'), 'user', ['cpr'], unique=False)
    op.create_index(op.f('ix_user_external_subject'), 'user', ['external_subject'], unique=False)
    op.create_index(op.f('ix_user_id'), 'user', ['id'], unique=False)
    op.create_index(op.f('ix_user_internal_subject'), 'user', ['internal_subject'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_user_internal_subject'), table_name='user')
    op.drop_index(op.f('ix_user_id'), table_name='user')
    op.drop_index(op.f('ix_user_external_subject'), table_name='user')
    op.drop_index(op.f('ix_user_cpr'), table_name='user')
    op.drop_table('user')
